...
class Cubierta(models.Model):
    ...
    posicion =models.CharField(max_length=20, default=True)
    posicion2 = models.CharField(max_length=10, default=True)
...
class Envases(models.Model):
    ...
    opcion1= models.CharField(max_length=50, default="")
    opcion2= models.CharField(max_length=50, default="")
